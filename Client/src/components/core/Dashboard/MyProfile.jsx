...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      {/* Top Section - Image and Edit */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 rounded-md border border-richblack-700 bg-richblack-800 p-6 sm:px-12">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <img
            src={user?.image}
            alt={`profile-${user?.firstName}`}
            className="aspect-square w-[78px] rounded-full object-cover object-top"
          />
      ...
      {/* About Section */}
      <div className="my-10 flex flex-col gap-4 rounded-md border border-richblack-700 bg-richblack-800 p-6 sm:px-12">
